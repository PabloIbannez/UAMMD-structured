...
pos0 = [0,    0, -H+z0]
pos1 = [dist, dist*0.5, -H+z0+dist*0.123]
...
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, 1, k, dist]]
...
for nIterations in iterationsList:
    ...
    simulation["simulationStep"][name]["data"] = [[0, pos0, 0],
                                                  [1, pos1, 0]]
...
if not os.path.exists("./results"):
    os.makedirs("./results")
simulation.write("./results/simulationDumble.json")
