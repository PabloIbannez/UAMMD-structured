...
if (maxError<threshold):
    print(f"TEST PAIRWISE_FORCES BOND3 PASSED: The maximum error is {maxError}")
else:
    print(f"TEST PAIRWISE_FORCES BOND3 FAILED: The maximum error is {maxError}")
