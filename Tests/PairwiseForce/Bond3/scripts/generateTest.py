...
simulation["system"]["info"]["parameters"]["name"] = "testPairwiseForces"
...
simulation["topology"]["forceField"]["Bond"]["labels"] = ["id_i", "id_j", "id_k", "K", "theta0"]
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, 1, 2, k, theta0]]

simulation["topology"]["forceField"]["Bond"]["parameters"] = {}
simulation["topology"]["forceField"]["Bond"]["type"] = ["Bond3", "HarmonicAngular"]
