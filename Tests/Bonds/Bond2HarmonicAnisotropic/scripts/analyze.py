...
if (maxError<threshold):
    print(f"TEST PAIRWISE_FORCES BOND2 PASSED: The maximum error is {maxError}")
else:
    print(f"TEST PAIRWISE_FORCES BOND2 FAILED: The maximum error is {maxError}")
