...
simulation["topology"]["forceField"]["helix"]["patchesTopology"]["forceField"]["helix"]["type"]       =  ["NonBondedPatches", "HelixCosine"]
simulation["topology"]["forceField"]["helix"]["patchesTopology"]["forceField"]["helix"]["parameters"] =  {"condition":"inter"}
simulation["topology"]["forceField"]["helix"]["patchesTopology"]["forceField"]["helix"]["labels"]     =  ["name_i", "name_j", "Eb", "theta_start", "theta_end", "phi_start", "phi_end", "r_start", "rc", "e_x", "e_y", "e_z"]
simulation["topology"]["forceField"]["helix"]["patchesTopology"]["forceField"]["helix"]["data"]       =  []

d = ["E", "S", E, theta_start, theta_end, phi_start, phi_end, r_start, rc]
