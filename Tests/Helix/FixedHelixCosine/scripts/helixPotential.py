...
def analyticPotential():
    ...
    U_dict['cos_theta_f'] = cos_theta_f
    U_dict['cos_theta_b'] = cos_theta_b

    U_dict['cos_theta_start'] = cos_theta_start
    U_dict['cos_theta_end']   = cos_theta_end

    U_dict['cos_phi_f'] = cos_phi_f
    U_dict['cos_phi_b'] = cos_phi_b

    U_dict['cos_phi_start'] = cos_phi_start
    U_dict['cos_phi_end']   = cos_phi_end
...
def computePerParticleHelixEnergyForceTorque(pos,ori,Eb,Kb,
                                             theta_start,theta_end,
                                             phi_start,phi_end,
