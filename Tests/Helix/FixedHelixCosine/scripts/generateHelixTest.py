...
theta_end   = parameters['theta_end']

phi_start = parameters['phi_start']
phi_end   = parameters['phi_end']
...
simulation["topology"]["forceField"]["helix"]["type"]       = ["Bond2", "HelixCosine"]
simulation["topology"]["forceField"]["helix"]["parameters"] = {}

simulation["topology"]["forceField"]["helix"]["parameters"]["Kb"]          = Kb
simulation["topology"]["forceField"]["helix"]["parameters"]["theta_start"] = theta_start
simulation["topology"]["forceField"]["helix"]["parameters"]["theta_end"]   = theta_end
simulation["topology"]["forceField"]["helix"]["parameters"]["phi_start"]   = phi_start
simulation["topology"]["forceField"]["helix"]["parameters"]["phi_end"]     = phi_end
