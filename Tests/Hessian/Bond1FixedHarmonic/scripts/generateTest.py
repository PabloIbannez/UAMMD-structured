...
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, k, r0, [0,0,0]]]
...
name = "Energy"
simulation["simulationStep"][name] = {}
simulation["simulationStep"][name]["type"] = ["ParticlesListMeasure", "PotentialMeasure"]
simulation["simulationStep"][name]["parameters"] = {}
simulation["simulationStep"][name]["parameters"]["outputFilePath"]     = "Energy.out"
simulation["simulationStep"][name]["parameters"]["intervalStep"]       = 1
simulation["simulationStep"][name]["data"] = [[0]]
simulation["simulationStep"][name]["labels"] = ["id"]
