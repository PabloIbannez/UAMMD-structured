...
simulation["topology"]["forceField"]["LJ"]["parameters"]["cutOffNPFactor"] = 2**(1./6.)
simulation["topology"]["forceField"]["LJ"]["parameters"]["cutOffDHFactor"] = 2**(1./6.)
...
simulation["topology"]["forceField"]["LJ"]["type"]       = ["NonBonded", "DLVOType1"]
