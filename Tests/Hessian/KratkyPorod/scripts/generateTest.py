...
simulation["topology"]["forceField"]["Bond"]["labels"] = ["id_i", "id_j", "id_k", "K"]
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, 1, 2, k]]

simulation["topology"]["forceField"]["Bond"]["parameters"] = {}
simulation["topology"]["forceField"]["Bond"]["type"] = ["Bond3", "KratkyPorod"]
