...
simulation["topology"]["forceField"]["LJ"]["parameters"]["cutOffNPFactor"] = 2
simulation["topology"]["forceField"]["LJ"]["parameters"]["cutOffDHFactor"] = 2
...
simulation["topology"]["forceField"]["LJ"]["type"]       = ["NonBonded", "KimHummer"]
