...
simulation["topology"]["forceField"]["Bond"]["labels"] = ["id_i", "id_j", "id_k", "id_l"]
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, 1, 2, 3]]

simulation["topology"]["forceField"]["Bond"]["parameters"] = {}
simulation["topology"]["forceField"]["Bond"]["type"] = ["Bond4", "IDP_Fourier"]
