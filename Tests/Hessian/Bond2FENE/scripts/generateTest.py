...
simulation["topology"]["forceField"]["Bond"]["labels"] = ["id_i", "id_j", "K", "r0", "R0"]
simulation["topology"]["forceField"]["Bond"]["data"] = [[0, 1, k, r0, R0]]

simulation["topology"]["forceField"]["Bond"]["parameters"] = {}
simulation["topology"]["forceField"]["Bond"]["type"] = ["Bond2", "Fene"]
