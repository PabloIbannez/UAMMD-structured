...
charge             = param["charge"]
dielectricConstant = param["dielectricConstant"]
debyeLength        = param["debyeLength"]
...
simulation["global"]["types"]["data"]  = [["A", 1, 0, charge]]
...
simulation["topology"]["forceField"]["LJ"]["parameters"]["cutOffFactor"] = 2
simulation["topology"]["forceField"]["LJ"]["parameters"]["condition"] = "all"
simulation["topology"]["forceField"]["LJ"]["parameters"]["dielectricConstant"] = dielectricConstant
simulation["topology"]["forceField"]["LJ"]["parameters"]["debyeLength"] = debyeLength

simulation["topology"]["forceField"]["LJ"]["type"]       = ["NonBonded", "DebyeHuckel"]
# simulation["topology"]["forceField"]["LJ"]["data"]       = [["A", "A", sig, eps]]
# simulation["topology"]["forceField"]["LJ"]["labels"]     = ["name_i", "name_j", "sigma", "epsilon"]
