...
pos1 = param["pos1"]
L    = param["L"]
eps_r= param["epsilon_r"]
eps_a= param["epsilon_a"]

eps = 0.2*eps_r+0.8*eps_a #Random numbers
...
simulation["topology"]["forceField"]["LJ"]["parameters"]["epsilon_r"] = eps_r
simulation["topology"]["forceField"]["LJ"]["parameters"]["epsilon_a"] = eps_a

simulation["topology"]["forceField"]["LJ"]["type"]       = ["NonBonded", "SplitLennardJones"]
