...
simulation["topology"]["forceField"]["LJ"]["parameters"]["lambda"]         = lambda_in
simulation["topology"]["forceField"]["LJ"]["parameters"]["gamma"]          = gamma

simulation["topology"]["forceField"]["LJ"]["parameters"]["condition"] = "all"

simulation["topology"]["forceField"]["LJ"]["type"]       = ["NonBonded", "Clashed"]
