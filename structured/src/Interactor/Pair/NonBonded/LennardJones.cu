...
#include "Interactor/BasicPotentials/GeneralLennardJones.cuh"
...
REGISTER_NONBONDED_INTERACTOR(
    NonBonded,LennardJonesType1,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::LennardJonesType1>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,LennardJonesType2,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::LennardJonesType2>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,LennardJonesType3,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::LennardJonesType3>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,WCAType1,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::WCAType1>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,WCAType2,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::WCAType2>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,WCAType3,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::WCAType3>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,GeneralLennardJonesType1,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::GeneralLennardJonesType1>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,GeneralLennardJonesType2,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::GeneralLennardJonesType2>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,GeneralLennardJonesType3,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::GeneralLennardJonesType3>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,Steric6,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::Steric6>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,Steric12,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::Steric12>
)
