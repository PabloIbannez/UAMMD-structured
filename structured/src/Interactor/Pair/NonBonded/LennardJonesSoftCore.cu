...
REGISTER_NONBONDED_INTERACTOR(
    NonBonded,LennardJonesSoftCoreType1,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::LennardJonesSoftCoreType1>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,LennardJonesSoftCoreType2,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::LennardJonesSoftCoreType2>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,Steric6SoftCore,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::Steric6SoftCore>
)

REGISTER_NONBONDED_INTERACTOR(
    NonBonded,Steric12SoftCore,
    uammd::structured::Interactor::PairInteractor<uammd::structured::Potentials::NonBonded::Steric12SoftCore>
)
