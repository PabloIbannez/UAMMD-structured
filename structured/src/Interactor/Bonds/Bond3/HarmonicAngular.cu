...
REGISTER_BOND_INTERACTOR(
    Bond3,HarmonicAngular,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond3::HarmonicAngular>
)

REGISTER_BOND_INTERACTOR(
    Bond3,HarmonicAngularCommon_K,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond3::HarmonicAngularCommon_K>
)

REGISTER_BOND_INTERACTOR(
    Bond3,HarmonicAngularCommon_K_theta0,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond3::HarmonicAngularCommon_K_theta0>
)
