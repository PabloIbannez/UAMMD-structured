...
REGISTER_BOND_INTERACTOR(
    Bond2,Gaussian,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Gaussian>
)

REGISTER_BOND_INTERACTOR(
    Bond2,GaussianCommon_E_r0_D,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::GaussianCommon_E_r0_D>
)
