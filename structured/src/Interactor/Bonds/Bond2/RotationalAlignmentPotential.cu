...
REGISTER_BOND_INTERACTOR(
    Bond2,HelixExponential,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::HelixExponential>
)

REGISTER_BOND_INTERACTOR(
    Bond2,HelixCosine,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::HelixCosine>
)
