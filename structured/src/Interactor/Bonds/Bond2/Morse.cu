...
#include "Interactor/BasicPotentials/Morse.cuh"
...
REGISTER_BOND_INTERACTOR(
    Bond2,Morse,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Morse>
)

REGISTER_BOND_INTERACTOR(
    Bond2,MorseCommon_D,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::MorseCommon_D>
)

REGISTER_BOND_INTERACTOR(
    Bond2,MorseCommon_r0_E_D,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::MorseCommon_r0_E_D>
)

REGISTER_BOND_INTERACTOR(
    Bond2,MorseWCACommon_eps0,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::MorseWCACommon_eps0>
)
