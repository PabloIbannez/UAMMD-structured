...
#include "Interactor/BasicPotentials/Fene.cuh"
...
REGISTER_BOND_INTERACTOR(
    Bond2,Fene,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Fene>
)

REGISTER_BOND_INTERACTOR(
    Bond2,FeneCommon_K_R0,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::FeneCommon_K_R0>
)

REGISTER_BOND_INTERACTOR(
    Bond2,FeneCommon_r0_K_R0,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::FeneCommon_r0_K_R0>
)
