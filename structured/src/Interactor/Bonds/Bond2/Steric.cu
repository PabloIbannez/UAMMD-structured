...
namespace Bond2{
    ...
    struct StericCommon_epsilon_sigma_{
        ...
        static __host__ ComputationalData getComputationalData(std::shared_ptr<GlobalData>           gd,
                                                               ...
                                                               const cudaStream_t& st){
            ComputationalData computational;
            static_cast<typename Steric_<power>::ComputationalData&>(computational) =
            Steric_<power>::getComputationalData(gd,pg,storage,
                                                 computables,st);
...
REGISTER_BOND_INTERACTOR(
    Bond2,Steric6,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Steric6>
)

REGISTER_BOND_INTERACTOR(
    Bond2,Steric6Common_epsilon_sigma,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Steric6Common_epsilon_sigma>
)

REGISTER_BOND_INTERACTOR(
    Bond2,Steric12,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Steric12>
)

REGISTER_BOND_INTERACTOR(
    Bond2,Steric12Common_epsilon_sigma,
    uammd::structured::Interactor::BondsInteractor<uammd::structured::Potentials::Bond2::Steric12Common_epsilon_sigma>
)
