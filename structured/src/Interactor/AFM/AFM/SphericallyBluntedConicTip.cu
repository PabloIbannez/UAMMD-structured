...
REGISTER_AFM_INTERACTOR(
    AFM,SphericallyBluntedConicTip,
    uammd::structured::Interactor::AFMInteractor<uammd::structured::Potentials::AFM::SphericallyBluntedConicTip>
)
