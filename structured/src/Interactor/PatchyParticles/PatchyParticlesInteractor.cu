...
namespace Interactor{
    ...
    void PatchyParticles_<THREADS_PER_BLOCK>::accumulate(uammd::Interactor::Computables comp,cudaStream_t st) {
    ...
    template<int THREADS_PER_BLOCK>
    PatchyParticles_<THREADS_PER_BLOCK>::PatchyParticles_(std::shared_ptr<GlobalData>    gd,
    ...
    template<int THREADS_PER_BLOCK>
    void PatchyParticles_<THREADS_PER_BLOCK>::updatePatchyParticles(cudaStream_t st){
    ...
    template<int THREADS_PER_BLOCK>
    InputEntryManager::entryInfo PatchyParticles_<THREADS_PER_BLOCK>::getPatchesInteractorInfo(std::string name){
    ...
    template<int THREADS_PER_BLOCK>
    void PatchyParticles_<THREADS_PER_BLOCK>::sum(uammd::Interactor::Computables comp,cudaStream_t st){
    ...
    template<int THREADS_PER_BLOCK>
    DynamicallyBondedPatchyParticles_<THREADS_PER_BLOCK>::DynamicallyBondedPatchyParticles_(std::shared_ptr<GlobalData>    gd,
                                                                                            std::shared_ptr<ParticleGroup> pg,
                                                                                            std::vector<std::string>     path,
    ...
    template<int THREADS_PER_BLOCK>
    void DynamicallyBondedPatchyParticles_<THREADS_PER_BLOCK>::updatePatchyParticles(cudaStream_t st){
    ...
    template<int THREADS_PER_BLOCK>
    void DynamicallyBondedPatchyParticles_<THREADS_PER_BLOCK>::sum(uammd::Interactor::Computables comp,cudaStream_t st){
    ...
    template class PatchyParticles_<>; //Default THREADS_PER_BLOCK
    template class DynamicallyBondedPatchyParticles_<>; //Default THREADS_PER_BLOCK
