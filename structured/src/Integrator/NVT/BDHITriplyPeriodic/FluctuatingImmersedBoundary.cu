...
namespace BDHITriplyPeriodic{
	...
	class FluctuatingImmersedBoundary : public IntegratorBaseNVT{
...
REGISTER_INTEGRATOR(
    BDHITriplePeriodic,FluctuatingImmersedBoundary,
    uammd::structured::Integrator::NVT::BDHITriplyPeriodic::FluctuatingImmersedBoundary
)
