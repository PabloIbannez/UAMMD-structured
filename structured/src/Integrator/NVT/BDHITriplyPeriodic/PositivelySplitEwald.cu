...
namespace BDHITriplyPeriodic{
	...
	class PositivelySplitEwald : public IntegratorBaseNVT{
...
REGISTER_INTEGRATOR(
    BDHITriplePeriodic,PositivelySplitEwald,
    uammd::structured::Integrator::NVT::BDHITriplyPeriodic::PositivelySplitEwald
)
