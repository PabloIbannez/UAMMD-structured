...
namespace SimulationMeasures{
    ...
    __global__ void computeVolume(int numberParticles,
                                  uammd::structured::VerletConditionalListSetBase::NeighbourListData nlData,
                                  Box    box,
                                  real4 *position,
                                  int*   id_ptr,
                                  real*  volume,
...
class StressMeasure: public SimulationStepBase{
        ...
        std::shared_ptr<uammd::structured::VerletConditionalListSetBase> nl;
    ...
    public:
        ...
        StressMeasure(std::shared_ptr<ParticleGroup>             pg,
            ...
            nl = VerletConditionalListSetFactory::getInstance().createVerletConditionalListSet("all",
                                                                                               gd,pg,
                                                                                               data,
                                                                                               "StructureMeasure");
...
REGISTER_SIMULATION_STEP(
    MechanicalMeasure,StressMeasure,
    uammd::structured::SimulationStep::SimulationMeasures::StressMeasure
)
