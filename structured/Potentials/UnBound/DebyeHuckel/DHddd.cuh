#ifndef __DHDDD_UNBOUND__
#define __DHDDD_UNBOUND__
...
namespace UnBound{
    ...
    struct DebyeHuckelDistanceDependentDielectric: public ParameterUpdatable{
        ...
        DebyeHuckelDistanceDependentDielectric(std::shared_ptr<ParticleData> pd,
                                               Parameters par):pd(pd),
                                                               debyeLenght(par.debyeLenght),
                                                               cutOff(par.cutOff){}

        ~DebyeHuckelDistanceDependentDielectric(){}
        ...
        struct forceTransverser{
            ...
            inline __device__ resultType compute(const int& index_i,const int& index_j,const real4& posi,const real4& posj){
                ...
                if(r2>0 and r2<=cutOff2){
                    ...
                    return make_real4(CommonPotentials::DebyeHuckel::DebyeHuckelDistanceDependentDielectric::force<Units_>(rij,r2,chgProduct,debyeLenght,
        ...
        struct virialTransverser{
            ...
            inline __device__ resultType compute(const int index_i,const int index_j,const real4 posi,const real4 posj){
                ...
                if(r2>0 and r2<=cutOff2){
                    ...
                    return CommonPotentials::DebyeHuckel::DebyeHuckelDistanceDependentDielectric::virial<Units_>(rij,r2,chgProduct,debyeLenght,
                                                                                                                 real(-8.5525),real(78.4)-real(-8.5525),
                                                                                                                 real(7.7839),
                                                                                                                 real(0.003627));
                } 
        ...
        struct energyTransverser{
            ...
            inline __device__ resultType compute(const int index_i,const int index_j,const real4 posi,const real4 posj){
                ...
                if(r2>0 and r2<=cutOff2){
                    ...
                    return CommonPotentials::DebyeHuckel::DebyeHuckelDistanceDependentDielectric::energy<Units_>(rij,r2,chgProduct,debyeLenght,
                                                                                                                 real(-8.5525),real(78.4)-real(-8.5525),
                                                                                                                 real(7.7839),
                                                                                                                 real(0.003627));
                } 
