...
#ifndef __INTEGRATOR_MAGNETIC_BROWNIAN__
#define __INTEGRATOR_MAGNETIC_BROWNIAN__
...
namespace Magnetic{
  ...
  public:
    ...
    Brownian(std::shared_ptr<GlobalData>       gd,
	     ...
	     DataEntry& data,
	     std::string name):Brownian::EulerMaruyamaRigidBody(gd,pg,data,"EulerMaruyamaRigidBody"){
