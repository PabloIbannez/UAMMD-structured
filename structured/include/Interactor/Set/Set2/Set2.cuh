#ifndef __SET2_CENTER_OF_MASS_POTENTIAL__
#define __SET2_CENTER_OF_MASS_POTENTIAL__
...
struct CenterOfMassEnergyTransverser_{
    ...
    inline __device__ propertyType compute(const ComputationalData& computational,
        ...
        const real  totalMass1 = reduced[0][0].w;
        const real3 com1 = computational.box.apply_pbc(make_real3(reduced[0][0])/totalMass1);

        const real  totalMass2 = reduced[0][1].w;
        const real3 com2 = computational.box.apply_pbc(make_real3(reduced[0][1])/totalMass2);

        return PotentialType::energy(com1,com2,computational,setParam);
    }
    ...
    inline __device__ spreadType spread(const propertyType& quantity,
        ...
        real totalMass = reduced[0][setIndex].w;
...
struct CenterOfMassForceTransverser_{
    ...
    inline __device__ propertyType compute(const ComputationalData& computational,
        ...
        return PotentialType::force(com1,com2,computational,setParam);
    }
    ...
    inline __device__ spreadType spread(const propertyType& quantity,
        ...
        return (computational.mass[index]/totalMass)*f;
    }
